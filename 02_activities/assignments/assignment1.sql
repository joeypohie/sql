...
CASE WHEN product_qty_type IS "lbs" OR product_qty_type IS "oz" THEN "unit"
ELSE "bulk"
...
SELECT v.vendor_name as vendor_name, vba.market_date as mkt_date
FROM vendor as v
INNER JOIN vendor_booth_assignments as vba ON v.vendor_id = vba.vendor_id
ORDER BY vendor_name, mkt_date;
...
INSERT INTO temp_table (vendor_id, vendor_name, vendor_type, vendor_owner_first_name, vendor_owner_last_name)
